...
function Eye({ className, onClick }: Props) {
  return (
    <div
      className={
        `${
        ...
        >
          <g id="eye-slash">
            <path
              ...
              transform="translate(179.67 195.67)"
              fill="#292d32"
            />
            <path
              id="Vector-2"
              ...
              transform="translate(173.465 190.98)"
              fill="#292d32"
            />
            <path
              id="Vector-3"
              ...
              transform="translate(179.662 195.18)"
              fill="#292d32"
            />
            <path
              id="Vector-4"
              ...
              transform="translate(183.936 199.959)"
              fill="#292d32"
            />
            <path
              id="Vector-5"
              ...
              transform="translate(173.253 201.783)"
              fill="#292d32"
            />
            <path
              id="Vector-6"
              ...
              transform="translate(185.783 189.253)"
              fill="#292d32"
            />
            <path
              id="Vector-7"
